...
export const people: Person[] = [
	...
	{ id: 'maria-eduarda-pinheiro', name: 'Maria Eduarda Pinheiro', homepage: 'https://scholar.google.com/citations?user=ajbjSkEAAAAJ&hl', alumni: [{ group: 'former-phd', currentPosition: 'Professor at the Department of Mathematics, Federal University of Santa Catarina, Blumenau Campus, Brazil', dissertation: { title: 'Mixed-Integer Optimization for Semi-Supervised Learning with Cardinality Constraints: Support Vector Machines, Classification Trees, and Random Forests', institution: 'Trier University', coSupervisor: 'jan-pablo-burgard' } }] },
